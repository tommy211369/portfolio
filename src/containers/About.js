  ...
  return (
    <div className="about pages">
      ...
      <p>
        ...
        en <span>octobre 2020</span> dans le monde du développement web.{" "}
      </p>
      <p>
        Je commence mon apprentissage avec l'<span>HTML</span> et{" "}
        <span>CSS</span> sur OpenClassrooms. Je me découvre alors petit à petit
        une nouvelle passion et je sais que je suis au bon endroit.
      </p>
      <p>
      ...
      <p>
        ...
        <span>bootcamp de 10 semaines, Le Reacteur</span>. Une formation où l'on
        se concentre sur la <span>MERN stack</span> : exactement ce que je
        cherchais !
      </p>
      <p>
